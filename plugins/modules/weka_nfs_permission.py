...
options:
    ...
    permission_id:
        description: Unique identifier of the nfs permission.
        type: str
    name:
        description: Display name of the nfs permission.
        type: str
"""
...
def main():
    ...
    if state == "present":
        if resource_id:
            result = client.update("nfs_permission", resource_id, module.params)
        else:
