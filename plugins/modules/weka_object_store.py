...
DOCUMENTATION = r"""
---
module: weka_object_store
short_description: Manage Weka object store backends
description:
    - Manage Weka object store backends.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.weka.weka_object_store:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("store_id",))],
    )
